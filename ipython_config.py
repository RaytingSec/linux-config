...
#         highlighting: 
#  monokai, rrt, autumn, colorful, friendly, bw, native, rainbow_dash, algol_nu, trac, borland, vim, murphy, arduino, xcode, emacs, paraiso-dark, abap, lovelace, default, pastie, fruity, manni, igor, paraiso-light, vs, algol, perldoc, tango
